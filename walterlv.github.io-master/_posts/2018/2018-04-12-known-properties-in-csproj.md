...
+ `%(FullPath)`
    - 文件的完全路径，例如: `C:\Users\dualxu\GitHub\Demo\Walterlv.DemoProject\src\Program.cs`
+ `%(RootDir)`
    - 文件所在的根目录，例如: `C:\`
+ `%(Filename)`
...
+ `%(RelativeDir)`
    - 文件所在的文件夹，例如: `src\`
+ `%(Directory)`
    - 除了根目录之外的目录，例如: `dualxu\GitHub\Demo\Walterlv.DemoProject\src\`
+ `%(RecursiveDir)`
    - 如果项是用通配符写的，那么此值表示匹配到某一项时的目录，例如: `dualxu\GitHub\Demo\Walterlv.DemoProject\src\`
+ `%(Identity)`
...
* 项目文件
    + `$(MSBuildProjectFullPath)`
        - 项目文件的绝对路径，例如: `C:\Users\dualxu\GitHub\Demo\Walterlv.DemoProject.csproj`
    + `$(MSBuildProjectDirectory)`
        - 项目所在的文件夹，例如: `C:\Users\dualxu\GitHub\Demo`
    + `$(MSBuildProjectFile)`
...
* 部件（例如 .props 文件或 .targets 文件，当然也包含 .csproj 文件）
    + `$(MSBuildThisFileFullPath)`
        - 用这个属性的文件所在的绝对路径，例如 `C:\Users\dualxu\.nuget\packages\dualxu.nuget.demo\2.13.0\build\netstandard2.0\Walterlv.NuGet.Demo.targets`
    + `$(MSBuildThisFileDirectory)`
        - 此文件所在的文件夹，例如: `C:\Users\dualxu\.nuget\packages\dualxu.nuget.demo\2.13.0\build\netstandard2.0\`
    + `$(MSBuildThisFile)`
