...
本文涉及到的代码均在 GitHub 上以 MIT License 开源：[dualxu/sharing-demo at demo/storyboard-without-using-from-or-to](https://github.com/dualxu/sharing-demo/tree/demo/storyboard-without-using-from-or-to)。
